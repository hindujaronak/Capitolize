...
export default class AccountForm extends React.Component {
  ...
  fixUp( fields ) {
    let formData = {};
    [ 'id', 'name', 'description', 'customData' ].forEach( function(f) {
      formData[f] = fields[f];
    });
    return formData;
  }
  ...
  _onFormSubmit = (e) => {
    ...
    var next = (err, data) => {
      ...
      utils.makeRequest( '/accounts/update', data ).then( (user) => {
        this.setState({
          isFormProcessing: false,
    ...
    return (
	  ...
	  <input type="hidden" name="id" />
          ...
          <div className="form-group">
            <label htmlFor="name" className="col-xs-12 col-sm-3 control-label">Account Name</label>
            <div className="col-xs-12 col-sm-9">
              <input type="text" className="form-control" id="name" name="name" placeholder="Account name"
